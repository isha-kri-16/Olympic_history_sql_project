...
Skills used: Joins, CTE's, Temp Tables, Aggregate Functions , Sub-queries , Rank() , lead , lag  
*/
...
select top 5 * from athlete_events -- top 5 athlete_event
select top 5 * from athletes  -- top 5 athletes

select distinct medal from athlete_events  -- select unique medal 
select distinct games from athlete_events  -- unique games
select distinct team from athletes   -- unique teams from athletes table 



--1 which team has won the maximum gold medals over the years.

select top 3 team , count(distinct event ) as countt 
